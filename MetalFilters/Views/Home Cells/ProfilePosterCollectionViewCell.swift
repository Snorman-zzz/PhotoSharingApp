...
protocol ProfilePosterCollectionViewCellDelegate: AnyObject {
...
final class ProfilePosterCollectionViewCell: UICollectionViewCell {
    static let identifier = "ProfilePosterCollectionViewCell"
    
    private var index = 0
    
    weak var delegate: ProfilePosterCollectionViewCellDelegate?
